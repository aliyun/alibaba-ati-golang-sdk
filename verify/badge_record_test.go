...
func TestParseATIBadgeRecord(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			txt:         "v=ati-badge1; version=v1.0.0; url=https://ati-tl.cnnic.cn:8180/api/v1/v1/agents/7b93c61c-e261-488c-89a3-f948119be0a0",
			wantErr:     false,
			wantFormat:  "ati-badge1",
			wantVersion: ptr(models.NewVersion(1, 0, 0)),
			wantURL:     "https://ati-tl.cnnic.cn:8180/api/v1/v1/agents/7b93c61c-e261-488c-89a3-f948119be0a0",
		},
		{
			name:    "ati-badge1 without version is error",
			txt:     "v=ati-badge1; url=https://ati-tl.cnnic.cn:8180/api/v1/v1/agents/835a27a8-6b20-4439-915e-668a9d36e469",
			wantErr: true,
		},
		{
		...
		},
		{
			...
			txt:         "v=ra-badge1; version=v1.0.0; url=https://ati-tl.cnnic.cn:8180/api/v1/v1/agents/test-id",
			wantErr:     false,
			wantFormat:  "ra-badge1",
			wantVersion: ptr(models.NewVersion(1, 0, 0)),
			wantURL:     "https://ati-tl.cnnic.cn:8180/api/v1/v1/agents/test-id",
		},
		{
			name:        "ra-badge1 without version",
			txt:         "v=ra-badge1; url=https://ati-tl.cnnic.cn:8180/api/v1/v1/agents/test-id",
			wantErr:     false,
			wantFormat:  "ra-badge1",
			wantVersion: nil,
			wantURL:     "https://ati-tl.cnnic.cn:8180/api/v1/v1/agents/test-id",
		},
		{
			...
			txt:         "v=ra-badge1; version=1.0.0; url=https://ati-tl.cnnic.cn:8180/api/v1/v1/agents/test-id",
			wantErr:     false,
			wantFormat:  "ra-badge1",
			wantVersion: ptr(models.NewVersion(1, 0, 0)),
			wantURL:     "https://ati-tl.cnnic.cn:8180/api/v1/v1/agents/test-id",
