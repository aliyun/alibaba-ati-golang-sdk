...
func TestGenerateCSR_VerifyOutput(t *testing.T) {
	...
	err := generateCSR("test", "host.example.com", "TestOrg", "US", "ati://v1.0.0.host.example.com", 2048, tmpDir)
	if err != nil {
...
func TestGenerateCSR_InvalidKeyPath(t *testing.T) {
	err := generateCSR("test", "host.example.com", "TestOrg", "US", "ati://v1.0.0.host.example.com", 2048, "/dev/null/nodir")
	if err == nil {
