	...
	v1 := &models.TransparencyLogV1{
		...
		Producer: models.ProducerV1{
			Event: models.EventV1{
				ATIID:     "test-ati-id",
				ATIName:   "ati://v1.0.0.example.com",
...
func TestPrintV1Payload(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			checks: []string{
				"V1", "test-log-id", "test-ati-id", "AGENT_REGISTERED",
	...
	tests := []struct {
	...
	}{
		{
				...
				Producer: models.ProducerV0{
					...
					Event: models.EventV0{
						...
						Metadata: &models.EventMetadata{
							...
							ATICapabilities: []string{"BASIC", "ADVANCED"},
						},
			...
			checks: []string{
				...
				"ATI/1.0", "Metadata", "Test agent", "https://example.com",
...
func TestPrintRawPayload(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			payload: map[string]any{
				"ansName":   "ati://v1.0.0.example.com",
				"ansId":     "test-id",
			...
			checks: []string{
				"Unknown", "ati://v1.0.0.example.com", "test-id",
