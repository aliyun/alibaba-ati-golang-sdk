	...
	tests := []struct {
	...
	}{
		{
			...
			agent: &models.AgentDetails{
				...
				DNSRecords: []models.DNSRecord{
					{
						Type:     "TXT",
						Name:     "_ati-badge.test.example.com",
						Value:    "v=ati-badge1",
						Required: true,
						Purpose:  "ATI badge verification",
					},
				},
				Links: []models.Link{
			...
			checks: []string{
				...
				"DNS Records:", "TXT", "_ati-badge",
				"required", "ATI badge verification",
				"Links:", "self",
		...
		},
		{
			...
			agent: &models.AgentDetails{
				...
				ATIName:          "nostatus.ati.example.com",
				Version:          "2.0.0",
				AgentStatus:      nil,
			},
